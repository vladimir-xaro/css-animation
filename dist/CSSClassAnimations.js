...
var CSSClassAnimations = /** @class */ (function () {
    function CSSClassAnimations(config) {
        ...
        this.els = Array.isArray(config.el) ? micro_dom_src.apply(void 0, CSSClassAnimations_spread(config.el)) : micro_dom_src(config.el);
        if (config.allow) {
        ...
        Object.keys(eventsListeners).forEach(function (key) { return _this[eventsListeners[key]] = _this[eventsListeners[key]].bind(_this); });
        this.els.forEach(function (el) { return _this.allow.forEach(function (event) { return el.addEventListener(event, _this[eventsListeners[event]]); }); });
    }
    ...
    CSSClassAnimations.prototype.addEvent = function (domEventKey) {
        ...
        this.els.forEach(function (el) { return el.addEventListener(domEventKey, _this[eventsListeners[domEventKey]]); });
    };
    CSSClassAnimations.prototype.removeEvent = function (domEventKey) {
        ...
        this.els.forEach(function (el) { return el.removeEventListener(domEventKey, _this[eventsListeners[domEventKey]]); });
    };
